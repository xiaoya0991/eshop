...
public class ShoppingCartServiceImpl implements ShoppingCartService {
     ...
     * @
     */
    private void setGoodsRelatedData(ShoppingCartItemDTO item) {
     ...
     * @
     */
    private void setStockRelatedData(ShoppingCartItemDTO item) {
     ...
     * @
     */
    private void setPromotionRelatedData(ShoppingCartItemDTO item) {
