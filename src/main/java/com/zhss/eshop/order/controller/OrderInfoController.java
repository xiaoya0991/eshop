...
import com.zhss.eshop.common.result.ResponseResult;
...
public class OrderInfoController {
     ...
     */
    @PostMapping("/create")
    public ResponseResult<CreateBO> create(@RequestBody OrderInfoDTO orderInfoDTO) {
       return ResponseResult.OK(orderInfoService.create(orderInfoDTO));
    }
    ...
    public ResponseResult<CancelBO> cancel(@PathVariable("id") Long id) {
        return ResponseResult.OK(orderInfoService.cancel(id));
    }
    ...
    public ResponseResult<UpdateReturnGoodsLogisticCodeBO> updateReturnGoodsLogisticCode(
            @PathVariable(value = "orderInfoId",
                    required = true) Long orderInfoId,
            String returnGoodsLogisticCode) {
        return ResponseResult.OK(orderInfoService.updateReturnGoodsLogisticCode(orderInfoId, returnGoodsLogisticCode));
    }
