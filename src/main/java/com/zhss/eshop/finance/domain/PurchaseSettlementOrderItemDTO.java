 ...
 *
 */
public class PurchaseSettlementOrderItemDTO extends AbstractObject {
	...
	public String toString() {
		return "PurchaseSettlementOrderItemDTO [id=" + id + ", purchaseSettlementOrderId=" + purchaseSettlementOrderId
