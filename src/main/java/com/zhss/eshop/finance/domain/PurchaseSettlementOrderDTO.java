...
public class PurchaseSettlementOrderDTO extends AbstractObject {
	...
	public List<PurchaseSettlementOrderItemDTO> getItems() {
		return items;
	}
	public void setItems(List<PurchaseSettlementOrderItemDTO> items) {
		this.items = items;
	}
	...
	public String toString() {
		return "PurchaseSettlementOrderDTO [id=" + id + ", purchaseInputOrderId=" + purchaseInputOrderId
