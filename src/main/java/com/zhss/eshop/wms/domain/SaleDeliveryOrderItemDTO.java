...
public class SaleDeliveryOrderItemDTO extends AbstractObject {
	...
	public boolean equals(Object obj) {
		...
		for(SaleDeliveryOrderPickingItemDTO pickingItem : this.getPickingItems()) {
			Boolean result = false;
			
			for(SaleDeliveryOrderPickingItemDTO otherPickingItem : other.getPickingItems()) {
				if(pickingItem.equals(otherPickingItem)) {
					result = true;
					break;
				}
			}
		...
		for(SaleDeliveryOrderSendOutDetailDTO sendOutDetail : this.getSendOutItems()) {
			Boolean result = false;
			
			for(SaleDeliveryOrderSendOutDetailDTO otherSendOutDetail : other.getSendOutItems()) {
				if(sendOutDetail.equals(otherSendOutDetail)) {
					result = true;
					break;
				}
			}
